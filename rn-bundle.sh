...
do
	case $opt in
		"Android")
			...
			com="react-native bundle --platform android --dev $dev --entry-file index.js --bundle-output android/app/src/main/assets/index.android.bundle --assets-dest android/app/src/main/res/"
			break
			;;
		"iOS")
			com="react-native bundle --platform ios --dev $dev --entry-file index.js --bundle-output ios/main.jsbundle --assets-dest ios"
			break
			;;
		"Cancel")
			exit 0
